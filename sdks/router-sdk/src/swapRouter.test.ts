import { BigintIsh, CurrencyAmount, Ether, Percent, Token, TradeType, WETH9 } from '@taibiex/sdk-core'
import { Pair, Route as V2Route, Trade as V2Trade } from '@taibiex/v2-sdk'
import {
  encodeSqrtRatioX96,
  FeeAmount,
  nearestUsableTick,
